...
const CourseTutorMVP = () => {
  ...
  const TEST_PARAGRAPH = "Yo computaaaaaahhhhhhhhhhh yesssss get in";
  // --- API Calls ---
  useEffect(() => {
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-6 overflow-y-auto bg-gray-50">
          {chatHistory.map((msg, index) => (
            ...
            >
              <div
                className={`max-w-[70%] rounded-lg p-4 shadow-sm ${msg.sender === "user" ? "bg-blue-600 text-white rounded-br-none" : "bg-white text-gray-800 border border-gray-200 rounded-bl-none"}`}
              >
                <p className="text-sm">
                  {msg.sender === "agent"
